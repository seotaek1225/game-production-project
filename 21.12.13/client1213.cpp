...
int main()
{
	...
	while (1)
	{
		...
		printf("[받은 데이터] x = %d, y = %d, hp = %d, mp = %d\n", temp->u.userInfo.x, temp->u.userInfo.y, temp->u.userInfo.hp, temp->u.userInfo.mp);
		//printf("address = %s, port = %d\n", temp->address, temp->portNum);
		msg.u.userInfo.x = temp->u.userInfo.x;
		msg.u.userInfo.y = temp->u.userInfo.y;
		msg.u.userInfo.hp = temp->u.userInfo.hp;
		msg.u.userInfo.mp = temp->u.userInfo.mp;
		msg.type = temp->type;
